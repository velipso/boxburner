...
class KerfTester extends GeneratorBase {
    ...
    generate(settings, { width, height, play, testCount, kerfStart, kerfIncrement }) {
        const { defaultThickness: thickness } = settings;
        const rect = new Rectangle();
        const bt = () => ({
            kind: 'ButtJoint',
...
export { AlongIntersection, BoxJoint, ButtJoint, DocumentBase, DocumentSVG, DrawBuilder, EdgeBase, GeneratorBase, KerfTester, MortiseAndTenonJoint, PlainBox, Rectangle, SettingsTypeDef, Surface, SurfaceBuilder, allEdges, allEdgesTypeDef, allGenerators, copyVec2, eps, expandPathByKerf, exportDocument, forwardVec2, linesIntersect };
