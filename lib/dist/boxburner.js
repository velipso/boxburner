...
//
class Surface {
    constructor(thickness, kerf, border, cuts, scores) {
...
export { ApplyKerf, BoxJoint, BoxNested, BoxPlain, ButtJoint, DocumentBase, DocumentSVG, EdgeBase, GeneratorBase, JointBase, KerfTester, LegEdge, MortiseAndTenonJoint, Rectangle, SettingsTypeDef, Shape, Surface, allEdges, allEdgesTypeDef, allGenerators, allJoints, boxJointFingerSpacer, edgeListTypeDef, exportDocument, geo, polybool };
