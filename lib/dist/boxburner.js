    ...
    generate(settings, { thickness, kerf, width, depth, height, scorePadding, wrapConnection, topCover, bottomCover, }) {
        ...
        const addTuck = (isTop, { notchWidth, notchHeight, }) => {
            ...
            border = border
                ...
                th -
                notchWidth * 0.2 -
                (depth - notchWidth) * 0.1, r2y - depth)
        ...
        const addLeftTab = (receiverWidth) => {
            border = border
                .combine(polybool
                .shape()
                .moveTo(0, 0)
                .bezierCurveTo(-receiverWidth, 0, -receiverWidth, 0, -receiverWidth, Math.min(receiverWidth, height / 2 - 0.5))
                .lineTo(-receiverWidth, Math.max(height - receiverWidth, height / 2 + 0.5))
        ...
        switch (wrapConnection.kind) {
            ...
            case 'tabs': {
                const { receiverWidth, tabWidth, tabHeight, tabInnerCut, tabCount } = wrapConnection.params;
                if (receiverWidth > 0) {
                    addLeftTab(receiverWidth);
                }
                for (let i = 0; i < tabCount; i++) {
                    ...
                    border = border
                        ...
                        .bezierCurveTo(r4x + r4w + th + tabWidth, y + ty, r4x + r4w + th + tabWidth, y + ty, r4x + r4w + th + tabWidth, y + ty + cy)
                        .lineTo(r4x + r4w + th + tabWidth, y)
                        .closePath())
                        .difference()
                        .combine(polybool
                        ...
                        .bezierCurveTo(r4x + r4w + th + tabWidth, y + h - ty, r4x + r4w + th + tabWidth, y + h - ty, r4x + r4w + th + tabWidth, y + h - ty - cy)
                        .lineTo(r4x + r4w + th + tabWidth, y + h)
                        .closePath())
                        .difference())
                        .union();
